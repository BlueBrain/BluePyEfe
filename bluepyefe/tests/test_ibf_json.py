def test_ibf_json():
    ...
    config = {"cells": {"970509hp2": {"etype": "etype",
                                      "exclude": [[-1.8],
                                                  [-1.8]],
                                      "experiments": {"step": {"files": ["rattus-norvegicus____hippocampus____ca1____interneuron____cac____970509hp2____97509008",
              ...
              "comment": [],
              "features": {"step": ["time_to_last_spike",
