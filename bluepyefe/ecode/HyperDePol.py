...
class HyperDePol(Recording):
    ...
    def __init__(self, config_data, reader_data, protocol_name="HyperDePol", efel_settings=None):
        super(HyperDePol, self).__init__(config_data, reader_data, protocol_name)
