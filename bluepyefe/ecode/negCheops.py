...
class NegCheops(Recording):
    ...
    def __init__(self, config_data, reader_data, protocol_name="NegCheops", efel_settings=None):
        super(NegCheops, self).__init__(config_data, reader_data, protocol_name)
